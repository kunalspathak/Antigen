...
namespace Antigen.Tree
{
    ...
    public struct Operator
    {
        ...
        private static readonly List<Operator> operators = new List<Operator>()
        {
            ...
            new Operator(SyntaxKind.SimpleAssignmentExpression,   "i=j",  Primitive.Any, Primitive.Any,    OpFlags.Binary | OpFlags.Math | OpFlags.Assignment),
        ...
        private Operator(SyntaxKind oper, string text, Primitive inputTypes, Primitive outputType, OpFlags flags)
        {
            Oper = oper;
            renderText = text;
